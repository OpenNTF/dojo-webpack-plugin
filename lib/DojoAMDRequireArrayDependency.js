...
DojoAMDRequireArrayDependency.Template = class DojoAMDRequireArrayDependencyTemplate extends AMDRequireArrayDependency.Template {

	contentForDependency(dep, comment) {
		if (dep.request === "require") {
			return this.contentForRequire(dep, comment);
