...
module.exports = class DojoAMDChunkTemplatePlugin {
	apply(compiler) {
		...
		compiler.plugin("compilation", (compilation, params) => {
			...
			compilation.chunkTemplate.plugin("render", this.render.bind(context));
			compilation.chunkTemplate.plugin("render absMids", this.renderAbsMid.bind(context));	// plugin specific event
			compilation.chunkTemplate.plugin("hash", this.hash.bind(context));
		});
	}
