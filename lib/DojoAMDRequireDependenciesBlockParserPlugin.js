...
module.exports = class DojoAMDRequireDependenciesBlockParserPlugin {
	...
	apply(parser) {
		...
		parser.plugin("expression require", this.expressionRequire.bind(context));
		parser.plugin("call require", this.callRequire.bind(context));
		parser.plugin("call require:amd:array", this.callRequireAmdArray.bind(context));
		parser.plugin("call require:amd:item", this.callRequireAmdItem.bind(context));
	}
