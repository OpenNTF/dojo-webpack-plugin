...
class DojoAMDRequireItemDependency extends ModuleDependency {
	...
	// Overrides base-class implementation.  Ensures that relative path deps using global require are not`
	// considered equal to relative path deps using context-sensitive require.
