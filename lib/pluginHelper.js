...
const {Tapable, SyncHook, SyncBailHook, SyncWaterfallHook, AsyncSeriesHook, AsyncSeriesBailHook, AsyncSeriesWaterfallHook} = require("tapable");
		...
		events.forEach(event => {
			...
			names.forEach(name => {
				...
				switch(hookType) {
					...
					case "AsyncSeriesBail" : obj.hooks[name] = new AsyncSeriesBailHook(args); break;
