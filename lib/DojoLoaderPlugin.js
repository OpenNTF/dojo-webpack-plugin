...
module.exports = class DojoLoaderPlugin {
	...
	apply(compiler) {
		...
		compiler.plugin("create-dojo-loader-scope", this.createLoaderScope.bind(this));
		compiler.plugin("create-embedded-loader-scope", this.createEmbeddedLoaderScope.bind(this));
...
Refer to https://github.com/OpenNTF/dojo-webpack-plugin/blob/master/README.md#building-the-dojo-loader`);
	...
	run1(compilation__, callback) {
		...
		fs.readFile(filename, 'utf-8', (err, content) => {
			...
			this.loaderScope = this.createLoaderScope(loaderConfig, content, filename);
			return callback();
		});
	}
