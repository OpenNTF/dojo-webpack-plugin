...
DojoAMDDependencyParserMixin(AMDRequireDependenciesBlockParserPlugin) {
	...
	apply(parser) {
		tap(parser, {
			...
			"callMemberChain require" : this.processCallRequire.bind(this, parser),
			"callMemberChainOfCallMemberChain require" : (expr__, calleeMembers__, call) => this.processCallRequire(parser, call),
