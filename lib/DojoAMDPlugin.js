...
const DojoAMDRequireDependenciesBlockParserPlugin = require("./DojoAMDRequireDependenciesBlockParserPlugin" + versionSuffix);
const DojoAMDDefineDependencyParserPlugin = require("./DojoAMDDefineDependencyParserPlugin" + versionSuffix);
const DojoAMDResolverPlugin = require("./DojoAMDResolverPlugin" + versionSuffix);
...
module.exports = class DojoAMDPlugin {
	...
	compilationPlugins(compilation, params) {
		...
		compilation.options.DojoAMDPlugin = this.options;
