...
module.exports = class DojoAMDPlugin {
	...
	apply(compiler) {
		...
		compiler.apply(
			new NormalModuleReplacementPlugin(/^dojo\/selector\/_loader!$/, "dojo/selector/lite?absMid=dojo/selector/_loader%21"),
			new NormalModuleReplacementPlugin(/^dojo\/request\/default!$/, "dojo/request/xhr?absMid=dojo/request/default%21"),
