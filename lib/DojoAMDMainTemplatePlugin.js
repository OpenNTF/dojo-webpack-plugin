...
module.exports = class DojoAMDMainTemplatePlugin {
	...
	apply(compiler) {
		...
		compiler.plugin("compilation", (compilation, params) => {
			...
			compilation.mainTemplate.plugin("bootstrap", this.bootstrap.bind(context));
			compilation.mainTemplate.plugin("require-extensions", this.requireExtensions.bind(context));
			compilation.mainTemplate.plugin("dojo-require-extensions", this.dojoRequireExtensions.bind(context)); // plugin specific event
			compilation.mainTemplate.plugin("render-dojo-config-vars", this.renderDojoConfigVars.bind(context)); // plugin specific event
			compilation.mainTemplate.plugin("hash", this.hash.bind(context));
		});
	}
