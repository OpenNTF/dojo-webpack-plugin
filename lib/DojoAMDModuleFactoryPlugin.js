...
module.exports = class DojoAMDModuleFactoryPlugin {
	...
	apply(compiler) {
		...
		compiler.plugin("normal-module-factory", (factory) => {
			...
			factory.plugin("add absMids from request", this.addAbsMidsFromRequest.bind(context));	// plugin specific event
			factory.plugin("before-resolve", this.beforeResolve.bind(context));
			factory.plugin("resolver", this.resolver.bind(context));
			factory.plugin("create-module", this.createModule.bind(context));
			compiler.plugin("compilation", compilation => {
				factory.plugin("module", this.module.bind(context, compilation));
			});
		});
	}
