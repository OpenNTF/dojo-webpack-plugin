...
**dojo-webpack-plugin** is a [Webpack](https://webpack.github.io/) plugin that supports using Webpack 1.x to build Dojo 1.x applications (tested with version 1.10).  Features include:
